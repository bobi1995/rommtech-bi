...
import { getVerify } from "../db/hooks/auth";
...
const MenuBar: React.FC = () => {
  ...
  const verifyUserAccess = async () => {
    if (token && access) {
      try {
        const response = await getVerify(token, access.join(","));
            ...
            <li>
              <NavLink to="/item">
                <p className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                  <svg
                    className="w-6 h-6 flex-shrink-0 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
          ...
          {access?.includes(2) ? (
            <li>
              ...
              <ul
                id="dropdown-example"
                className={
                  isSubMenuOpen ? "py-2 space-y-2" : "hidden py-2 space-y-2"
                }
              >
                <li>
                  <NavLink
          ...
          <li>
            <NavLink to="/login">
              <p className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">Вход</span>
              </p>
            </NavLink>
          </li>
          <li>
